...
def loadU08520Map(robot: cozmo.robot.Robot):
        ...
        landmarks = {
                ...
                robot.world.define_custom_wall(CustomObjectTypes.CustomType08, CustomObjectMarkers.Diamonds2, 200,60,50,50,True): Object2D(Frame2D.fromXYA(0,800,0),30,400)}
